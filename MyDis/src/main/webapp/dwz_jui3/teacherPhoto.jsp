...
<form id="pagerForm" method="post" action="../teacherPhotoPage">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="../teacherPhotoPage" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	...
	<div width="100%" layoutH="68" style="border:1px black solid">
			...
			<c:forEach items="${teacherPhoto}" var="th">
				<c:if test="${fn:contains(th.t_img,'http://www.woniuxy.com')==true}">
					<div class="mypagediv"  >
						<div class="mypagediv1">
							<div ><a target="_blank" href="${th.t_img }"><img src="${th.t_img }"  height="200" width="200"/></a></div> 
							<div><span style="font-size: 15px; padding-top: 5px">${th.t_name }</span></div>
							<div style="margin-top: 15px">
								<div style="text-align:center; color: red;">
										<a href="../deleteTeacherPage?id=${th.id }" target="dialog" width="200" height="100" rel="head_dialog">
				...
				<c:if test="${fn:contains(th.t_img,'http://www.woniuxy.com')==false}">
				<div class="mypagediv"  >
						<div class="mypagediv1">
							<div ><a target="_blank" href="../../${th.t_img }"><img src="../../${th.t_img }"  height="200" width="200"/></a></div> 
							<div><span style="font-size: 15px; padding-top: 5px">${th.t_name }</span></div>
